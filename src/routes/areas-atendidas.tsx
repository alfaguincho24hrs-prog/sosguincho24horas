  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <h2 className="text-2xl font-bold mb-6 text-accent">Cidades em destaque</h2>
        ...
        <div className="mb-12 rounded-2xl bg-secondary/30 p-8 border border-border/40">
          ...
          <div className="flex flex-wrap gap-4">
            <Button asChild size="lg" className="bg-[image:var(--gradient-cta)] text-primary">
              <a href="https://wa.me/5511996451510"><Phone className="h-4 w-4" /> Solicitar agora</a>
            </Button>
            <Button asChild size="lg" variant="outline">
              <a href="https://wa.me/5511996451510" target="_blank" rel="noreferrer"><MessageCircle className="h-4 w-4" /> WhatsApp</a>
            </Button>
          </div>
        </div>
